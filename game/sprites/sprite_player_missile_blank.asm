...
sprite_player_missile_blank_dims:	EQU 0x0204
sprite_player_missile_blank_dim_x_bytes:	EQU 0x02
sprite_player_missile_blank_dim_y_pixels:	EQU 0x04

; Lookup table
sprite_player_missile_blank:
	WORD sprite_player_missile_blank_0, sprite_player_missile_blank_1, sprite_player_missile_blank_2, sprite_player_missile_blank_3, sprite_player_missile_blank_4, sprite_player_missile_blank_5, sprite_player_missile_blank_6, sprite_player_missile_blank_7
