...
_STATE_NO_SAUCER_VALUE:                 EQU 0b00000001          ; No active saucer
_STATE_ACTIVE_VALUE:                    EQU 0b00000010          ; Active saucer
_STATE_EXPLODING_VALUE:                 EQU 0b00000100          ; Saucer is exploding
_STATE_DONE_EXPLODING_VALUE:            EQU 0b00001000          ; Explosion completed
_STATE_LEAVING_SCREEN_VALUE:            EQU 0b00010000          ; Saucer has reached a screen edge
_STATE_SHOWING_SCORE_VALUE:             EQU 0b00100000          ; Showing the "mystery" saucer score
_STATE_DONE_SHOWING_SCORE_VALUE:        EQU 0b01000000          ; Done showing saucer score

_STATE_NO_SAUCER_BIT:                   EQU 0
_STATE_ACTIVE_BIT:                      EQU 1
_STATE_EXPLODING_BIT:                   EQU 2
_STATE_DONE_EXPLODING_BIT:              EQU 3
_STATE_LEAVING_SCREEN_BIT:              EQU 4
_STATE_SHOWING_SCORE_BIT:               EQU 5
_STATE_DONE_SHOWING_SCORE_BIT:          EQU 6
...
_explosion_countdown:                   BLOCK 1
_score_countdown:                        BLOCK 1
